<template web>
  <div class="fb-md-checkbox__container">
    <label class="fb-md-checkbox__label">
      ...
      <span :class="['fb-md-checkbox__indicator', {'has-error': hasError}]" />
      <span
        v-if="$slots.default || label"
        :class="['fb-md-checkbox__indicator-label', {'has-error': hasError}]"
      >
        <slot>{{ label }}</slot>
      </span>
    </label>
  ...
  export default {
    ...
    computed: {
      ...
      model: {
        ...
        set(val) {
          if (this.isGroup) {
            ...
            while (parent && (!name || name !== 'FbMdFormCheckboxesGroup')) {
      ...
      isGroup() {
        ...
        while (parent) {
          if (parent.$options.name !== 'FbMdFormCheckboxesGroup') {
            parent = parent.$parent
          } else {
