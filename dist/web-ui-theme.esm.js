...
var script$m = defineComponent({
  ...
  props: {
    ...
    variant: {
      ...
      validator: value => {
        // The value must match one of these strings
        return [FbModalVariantType.DEFAULT, FbModalVariantType.PHONE].includes(value);
      }
    },
    submitBtnLabel: {
      type: String,
