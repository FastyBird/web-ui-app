...
var __vue_inject_styles__$m = function __vue_inject_styles__(inject) {
  ...
  inject("data-v-2428667c_0", {
    source: ".fb-content-mt-lg{margin-top:3rem}.fb-content-mt-md{margin-top:1.5rem}.fb-content-mt-sm{margin-top:1rem}.fb-content-mt-xs{margin-top:.5rem}.fb-content-mb-lg{margin-bottom:3rem}.fb-content-mb-md{margin-bottom:1.5rem}.fb-content-mb-sm{margin-bottom:1rem}.fb-content-mb-xs{margin-bottom:.5rem}.fb-content-ml-lg{margin-left:3rem}.fb-content-ml-md{margin-left:1.5rem}.fb-content-ml-sm{margin-left:1rem}.fb-content-ml-xs{margin-left:.5rem}.fb-content-ml-lg{margin-right:3rem}.fb-content-ml-md{margin-right:1.5rem}.fb-content-ml-sm{margin-right:1rem}.fb-content-ml-xs{margin-right:.5rem}.fb-content-mh-lg{margin-left:3rem;margin-right:3rem}.fb-content-mh-md{margin-left:1.5rem;margin-right:1.5rem}.fb-content-mh-sm{margin-left:1rem;margin-right:1rem}.fb-content-mh-xs{margin-left:.5rem;margin-right:.5rem}.fb-content-mv-lg{margin-top:3rem;margin-bottom:3rem}.fb-content-mv-md{margin-top:1.5rem;margin-bottom:1.5rem}.fb-content-mv-sm{margin-top:1rem;margin-bottom:1rem}.fb-content-mv-xs{margin-top:.5rem;margin-bottom:.5rem}.fb-content-pt-lg{padding-top:3rem}.fb-content-pt-md{padding-top:1.5rem}.fb-content-pt-sm{padding-top:1rem}.fb-content-pt-xs{padding-top:.5rem}.fb-content-pb-lg{padding-bottom:3rem}.fb-content-pb-md{padding-bottom:1.5rem}.fb-content-pb-sm{padding-bottom:1rem}.fb-content-pb-xs{padding-bottom:.5rem}.fb-content-pl-lg{padding-left:3rem}.fb-content-pl-md{padding-left:1.5rem}.fb-content-pl-sm{padding-left:1rem}.fb-content-pl-xs{padding-left:.5rem}.fb-content-pl-lg{padding-right:3rem}.fb-content-pl-md{padding-right:1.5rem}.fb-content-pl-sm{padding-right:1rem}.fb-content-pl-xs{padding-right:.5rem}.fb-content-ph-lg{padding-left:3rem;padding-right:3rem}.fb-content-ph-md{padding-left:1.5rem;padding-right:1.5rem}.fb-content-ph-sm{padding-left:1rem;padding-right:1rem}.fb-content-ph-xs{padding-left:.5rem;padding-right:.5rem}.fb-content-pv-lg{padding-top:3rem;padding-bottom:3rem}.fb-content-pv-md{padding-top:1.5rem;padding-bottom:1.5rem}.fb-content-pv-sm{padding-top:1rem;padding-bottom:1rem}.fb-content-pv-xs{padding-top:.5rem;padding-bottom:.5rem}",
    map: undefined,
    media: undefined
  });
};
...
var __vue_module_identifier__$n = "data-v-114a9f60";
/* functional template */
...
var __vue_module_identifier__$o = "data-v-4fa224b6";
/* functional template */
...
var __vue_module_identifier__$p = "data-v-5eab4f01";
/* functional template */
...
var __vue_module_identifier__$q = "data-v-178bea14";
/* functional template */
...
var __vue_module_identifier__$r = "data-v-77def1a4";
/* functional template */
...
var __vue_module_identifier__$w = "data-v-121465b6";
/* functional template */
...
var __vue_scope_id__$x = "data-v-d4c1cb8c";
/* module identifier */

var __vue_module_identifier__$x = "data-v-d4c1cb8c";
/* functional template */
...
var __vue_render__$y = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<div class=\"fb-component-loading__spinner\"></div> <p>\n    Preparing content, please wait...\n  </p>")]);
};
...
var __vue_module_identifier__$y = "data-v-fe07c770";
/* functional template */
...
var __vue_module_identifier__$z = "data-v-a7620522";
/* functional template */
...
var __vue_module_identifier__$A = "data-v-9f36c062";
/* functional template */
...
var __vue_render__$B = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<div>", "</div>", _vm._l(_vm.buttons, function (button, index) {
    return _vm._ssrNode("<div" + _vm._ssrClass(null, ["fb-bottom-navigation__item-" + _vm.columns]) + ">", "</div>", [_c('item', {
      attrs: {
        "item": button
      }
    })], 1);
...
var __vue_module_identifier__$B = "data-v-36070f02";
/* functional template */
...
var __vue_module_identifier__$C = "data-v-c1fc94e0";
/* functional template */
...
var __vue_render__$D = function __vue_render__() {
  ...
  }, [_vm._ssrNode((_vm.subHeading === null ? "<h1>" + _vm._ssrEscape("\n    " + _vm._s(_vm.heading) + "\n  ") + "</h1>" : "<h1><span>" + _vm._ssrEscape(_vm._s(_vm.heading)) + "</span> <small>" + _vm._ssrEscape(_vm._s(_vm.subHeading)) + "</small></h1>") + " "), _vm._ssrNode("<div class=\"fb-desktop-header__buttons\">", "</div>", [_vm.leftButton !== null ? _c('action-button', {
  ...
  }) : _vm._e(), _vm._ssrNode(" "), _vm.rightButton !== null ? _c('action-button', {
    staticClass: "fb-desktop-header__button",
    attrs: {
  ...
  }) : _vm._e(), _vm._ssrNode(" "), _vm.actionButton !== null ? _c('action-button', {
    staticClass: "fb-desktop-header__button",
    attrs: {
      "name": "name",
      "icon": "plus",
...
var __vue_module_identifier__$D = "data-v-034409ac";
/* functional template */
...
var __vue_module_identifier__$E = "data-v-5d15b1f3";
/* functional template */
...
var __vue_render__$F = function __vue_render__() {
  ...
  return _c('nav', {
    ...
    return _vm._ssrNode("<ul>", "</ul>", [_vm._ssrNode("<li class=\"fb-navigation__heading\">" + _vm._ssrEscape("\n      " + _vm._s(item.meta.label) + "\n    ") + "</li> "), _vm._l(item.items, function (subItem, subIndex) {
      return [subItem.hasOwnProperty('link') && (!subItem.hasOwnProperty('access') || subItem.access(_vm.instance)) ? _vm._ssrNode("<li" + _vm._ssrClass(null, [{
        'active': _vm.$route.fullPath === subItem.link
      }, subItem.meta.hasOwnProperty('class') ? subItem.meta.class : '']) + ">", "</li>", [subItem.link ? _c('nuxt-link', {
        attrs: {
          "to": subItem.link,
          "active-class": "active"
        }
      ...
      }, [_vm._v(_vm._s(subItem.meta.label))])]) : _vm._e()], 1) : _vm._e(), _vm._ssrNode(" "), subItem.hasOwnProperty('callback') ? _vm._ssrNode("<li" + _vm._ssrClass(null, [subItem.meta.hasOwnProperty('class') ? subItem.meta.class : '']) + ">", "</li>", [_vm._ssrNode("<a href=\"#\">", "</a>", [_vm._ssrNode("<span class=\"fb-navigation__item-icon\">", "</span>", [_c('font-awesome-icon', {
        attrs: {
          "icon": subItem.meta.icon
        }
      })], 1), _vm._ssrNode(" <span class=\"fb-navigation__item-label\">" + _vm._ssrEscape(_vm._s(subItem.meta.label)) + "</span>")], 2)]) : _vm._e()];
    })], 2);
  }), 0);
};
...
var __vue_module_identifier__$F = "data-v-3451903a";
/* functional template */
...
var __vue_module_identifier__$G = "data-v-a453bb32";
/* functional template */
...
var __vue_module_identifier__$H = "data-v-02df0704";
/* functional template */
...
var __vue_render__$I = function __vue_render__(_h, _vm) {
  ...
  }, [_vm._ssrNode("<span>Toggle navigation</span> <div class=\"bars\"><span class=\"bar-line bar-line-1 out\"></span> <span class=\"bar-line bar-line-2 out\"></span> <span class=\"bar-line bar-line-3 out\"></span></div> <div class=\"bars bars-x\"><span class=\"bar-line bar-line-4\"></span> <span class=\"bar-line bar-line-5\"></span></div>")]);
};
...
var __vue_module_identifier__$I = "data-v-4df69e46";
/* functional template */
...
var __vue_module_identifier__$J = "data-v-e31d682a";
/* functional template */
...
var __vue_module_identifier__$K = "data-v-2cabf83a";
/* functional template */
...
var __vue_render__$L = function __vue_render__() {
  ...
  return _c('div', {
  ...
  }, [_vm._ssrNode("<div class=\"fb-phone-header__row\">", "</div>", [_vm.headingStyle === 'normal' ? _c('heading', {
    attrs: {
      "heading": _vm.heading,
    ...
    on: {
      "iconClicked": function iconClicked($event) {
        return _vm.$emit('iconClicked');
      }
    }
  }) : _vm._e(), _vm._ssrNode(" "), _vm.leftButton !== null ? _c('action-button', {
  ...
  }) : _vm._e(), _vm._ssrNode(" "), _vm.rightButton === null || _vm.leftButton === null ? _c('hamburger-button', {
    class: ['fb-phone-header__button', {
  ...
  }) : _vm._e()], 2), _vm._ssrNode(" "), _vm.headingStyle === 'row' && _vm.heading !== null ? _c('heading', {
  ...
  }) : _vm._e(), _vm._ssrNode(" " + (_vm.infoText !== null ? "<p class=\"fb-phone-header__info\">" + _vm._ssrEscape("\n    " + _vm._s(_vm.infoText) + "\n  ") + "</p>" : "<!---->") + " "), _vm.tabs.length > 0 ? _c('tabs', {
    attrs: {
      "tabs": _vm.tabs
    }
  }) : _vm._e(), _vm._ssrNode(" "), _vm.actionButton !== null ? _c('fb-button', {
...
var __vue_module_identifier__$L = "data-v-6d8d8842";
/* functional template */
...
var __vue_module_identifier__$M = "data-v-1697d423";
/* functional template */
...
var __vue_render__$N = function __vue_render__() {
  ...
  }, [_vm.isSignUp ? _vm._ssrNode("<p>", "</p>", [_vm._ssrNode(_vm._ssrEscape("\n    " + _vm._s(_vm.alreadyHaveAccountText) + "\n    ")), _c('nuxt-link', {
    attrs: {
      "to": _vm.signInLink
    }
  }, [_vm._v("\n      " + _vm._s(_vm.signInLabel) + "\n    ")])], 2) : _vm._ssrNode("<p>", "</p>", [_vm._ssrNode(_vm._ssrEscape("\n    " + _vm._s(_vm.withoutAccountText) + "\n    ")), _c('nuxt-link', {
    attrs: {
      "to": _vm.signUpLink
    }
  }, [_vm._v("\n      " + _vm._s(_vm.signUpLabel) + "\n    ")])], 2), _vm._ssrNode(" "), _vm._ssrNode("<ul>", "</ul>", [_vm._ssrNode("<li>", "</li>", [_c('nuxt-link', {
    attrs: {
      "to": _vm.signUpLink
    }
  }, [_vm._v("\n        " + _vm._s(_vm.signUpLabel) + "\n      ")])], 1), _vm._ssrNode(" <li>|</li> <li><a href=\"#\">" + _vm._ssrEscape(_vm._s(_vm.privacyPolicyLabel)) + "</a></li> <li>|</li> <li><a href=\"#\">" + _vm._ssrEscape(_vm._s(_vm.termsLabel)) + "</a></li> <li>|</li> <li><a href=\"#\">" + _vm._ssrEscape(_vm._s(_vm.cookiePolicyLabel)) + "</a></li> <li class=\"fb-sign-footer__owner\">\n      ©\n      " + (_vm.authorWebsite !== null ? "<a" + _vm._ssrAttr("href", _vm.authorWebsite) + " target=\"_blank\">" + _vm._ssrEscape("\n        " + _vm._s(_vm.authorName) + "\n      ") + "</a>" : "<!---->") + " 2017\n    </li>")], 2)], 2);
};
...
var __vue_module_identifier__$N = "data-v-5d325c3f";
/* functional template */
...
var __vue_module_identifier__$O = "data-v-e74d9fd4";
/* functional template */
...
var script$P = {
  ...
  watch: {
    collapsed: function collapsed(val) {
      ...
      if (!val) {
        this.$nextTick(function () {
          _this.$refs['user-navigation'].focus();
        });
      }
    }
  },
  methods: {
    callCallback: function callCallback(item) {
      var that = this;
      this.blur();
      setTimeout(function () {
        item.callback(that);
...
var __vue_render__$P = function __vue_render__() {
  ...
  return _c('div', {
    ...
    }, [_vm._v("\n          " + _vm._s(item.meta.label) + "\n        ")])], 1) : _vm._e(), _vm._ssrNode(" " + (item.hasOwnProperty('callback') ? "<li><a href=\"#\">" + _vm._ssrEscape("\n          " + _vm._s(item.meta.label) + "\n        ") + "</a></li>" : "<!---->") + " " + (item.name === 'divider' ? "<li class=\"divider\"></li>" : "<!---->"))];
  })], 2)], 2);
};
...
var __vue_render__$Q = function __vue_render__() {
  ...
  return _c('div', {
    ...
    on: {
      ...
      "leftButtonClicked": function leftButtonClicked($event) {
        return _vm.$emit('headingLeftButtonClicked');
      },
      "rightButtonClicked": function rightButtonClicked($event) {
        return _vm.$emit('headingRightButtonClicked');
      },
      "actionButtonClicked": function actionButtonClicked($event) {
    ...
    slot: "add-icon"
  })], 1), _vm._ssrNode(" "), _c('fb-desktop-header', {
    ref: "desktop-header",
    attrs: {
      "heading": _vm.heading,
      "sub-heading": _vm.subHeading,
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"fb-default-layout__sidebar\">", "</div>", [_vm._ssrNode("<div class=\"fb-default-layout__sidebar-header\">", "</div>", [_c('fb-logo', {
    attrs: {
      "link": _vm.homeLink
    }
  })], 1), _vm._ssrNode(" "), _c('fb-navigation', {
    attrs: {
      "items": _vm.menuItems
    }
  }), _vm._ssrNode(" "), _vm.hasProfile ? _vm._ssrNode("<div class=\"fb-default-layout__sidebar-footer\">", "</div>", [_c('fb-user-side-navigation', {
    attrs: {
  ...
  })], 1) : _vm._e()], 2), _vm._ssrNode(" "), _c('fb-phone-navigation', {
    attrs: {
  ...
  }), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"fb-default-layout__content\"" + _vm._ssrStyle(null, "height: " + (_vm.viewportHeight - _vm.contentHeightAdjust) + "px; margin-bottom: " + _vm.paddingBottom + "px;", null) + ">", "</div>", [_vm._t("content")], 2), _vm._ssrNode(" <div class=\"fb-default-layout__footer\"><div class=\"fb-default-layout__footer-body\"><small>© 2017 " + (_vm.authorWebsite !== null ? "<a" + _vm._ssrAttr("href", _vm.authorWebsite) + " target=\"_blank\" rel=\"noreferrer\">" + _vm._ssrEscape("\n        " + _vm._s(_vm.authorName)) + "</a>" : "<!---->") + "</small></div></div> "), _c('fb-bottom-navigation', {
...
var __vue_module_identifier__$Q = "data-v-7cea0f4d";
/* functional template */
...
var __vue_render__$R = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<div class=\"fb-error-layout__body\">", "</div>", [_vm._ssrNode("<h1>" + _vm._ssrEscape(_vm._s(_vm.message)) + "</h1> <h4>" + _vm._ssrEscape(_vm._s(_vm.description)) + "</h4> "), _vm._t("info"), _vm._ssrNode(" "), _vm._ssrNode("<p>", "</p>", [_c('fb-button', {
    attrs: {
      "to": _vm.homeLink,
      "pill": "",
      "variant": "primary"
    }
  }, [_vm._v("\n        Return to homepage\n      ")])], 1)], 2), _vm._ssrNode(" "), _vm._ssrNode("<div class=\"fb-error-layout__footer\">", "</div>", [_vm._ssrNode("<ul>", "</ul>", [_vm._ssrNode("<li>", "</li>", [_vm._ssrNode("<a href=\"https://twitter.com/FastyBird\" target=\"_blank\" rel=\"noreferrer\">", "</a>", [_c('font-awesome-icon', {
    attrs: {
      "icon": ['fab', 'twitter']
    }
  })], 1)]), _vm._ssrNode(" "), _vm._ssrNode("<li>", "</li>", [_vm._ssrNode("<a href=\"https://www.facebook.com/FastyBird\" target=\"_blank\" rel=\"noreferrer\">", "</a>", [_c('font-awesome-icon', {
    attrs: {
      "icon": ['fab', 'facebook']
    }
  })], 1)]), _vm._ssrNode(" "), _vm._ssrNode("<li>", "</li>", [_vm._ssrNode("<a href=\"https://github.com/fastybird\" target=\"_blank\" rel=\"noreferrer\">", "</a>", [_c('font-awesome-icon', {
    attrs: {
      "icon": ['fab', 'github']
    }
  })], 1)])], 2), _vm._ssrNode(" <p><small>© 2017 " + (_vm.authorWebsite !== null ? "<a" + _vm._ssrAttr("href", _vm.authorWebsite) + " target=\"_blank\" rel=\"noreferrer\">" + _vm._ssrEscape(_vm._s(_vm.authorName)) + "</a>" : "<!---->") + "</small></p>")], 2)], 2);
};
...
var __vue_module_identifier__$R = "data-v-65a96774";
/* functional template */
...
var __vue_render__$S = function __vue_render__() {
  ...
  }, [_vm._ssrNode("<div class=\"fb-sign-layout__box\">", "</div>", [_c('fb-sign-header', {
    attrs: {
      "sign-in-link": _vm.signInLink
    }
  }), _vm._ssrNode(" "), _vm._t("content")], 2), _vm._ssrNode(" "), _c('fb-sign-footer', {
    attrs: {
      "sign-in-link": _vm.signInLink,
...
var __vue_module_identifier__$S = "data-v-2e615486";
/* functional template */
...
var __vue_component__$S = /*#__PURE__*/normalizeComponent({
  render: __vue_render__$S,
  staticRenderFns: __vue_staticRenderFns__$S
}, __vue_inject_styles__$S, __vue_script__$S, __vue_scope_id__$S, __vue_is_functional_template__$S, __vue_module_identifier__$S, false, undefined, createInjectorSSR, undefined);var install = function installWebUiTheme(Vue) {
...
exports.FbAlert=__vue_component__$h;exports.FbBottomNavigation=__vue_component__$B;exports.FbButton=__vue_component__$i;exports.FbCardBox=__vue_component__$j;exports.FbComponentLoading=__vue_component__$y;exports.FbComponentLoadingError=__vue_component__$z;exports.FbConfirmationWindow=__vue_component__$l;exports.FbContent=__vue_component__$m;exports.FbDesktopHeader=__vue_component__$D;exports.FbDivider=__vue_component__$n;exports.FbFormCheckbox=__vue_component__$6;exports.FbFormCheckboxesGroup=__vue_component__$7;exports.FbFormInput=__vue_component__$3;exports.FbFormRadioButton=__vue_component__$8;exports.FbFormRadioButtonsGroup=__vue_component__$9;exports.FbFormSelect=__vue_component__$4;exports.FbFormTextArea=__vue_component__$5;exports.FbLayoutDefault=__vue_component__$Q;exports.FbLayoutError=__vue_component__$R;exports.FbLayoutSign=__vue_component__$S;exports.FbLoadingBox=__vue_component__$o;exports.FbLogo=__vue_component__$E;exports.FbMdFormDatePicker=__vue_component__$a;exports.FbMdFormInput=__vue_component__$e;exports.FbMdFormSelect=__vue_component__$f;exports.FbMdFormTextArea=__vue_component__$g;exports.FbModalForm=__vue_component__$p;exports.FbModalInfo=__vue_component__$q;exports.FbModalWindow=__vue_component__$r;exports.FbNavigation=__vue_component__$F;exports.FbPageLoading=__vue_component__$s;exports.FbPhoneHeader=__vue_component__$L;exports.FbPhoneNavigation=__vue_component__$M;exports.FbResultErr=__vue_component__$t;exports.FbResultOk=__vue_component__$u;exports.FbSignFooter=__vue_component__$N;exports.FbSignHeader=__vue_component__$O;exports.FbSpinner=__vue_component__$v;exports.FbSwitchElement=__vue_component__$w;exports.FbTransitionExpand=__vue_component__$x;exports.FbUserSideNavigation=__vue_component__$P;exports.default=plugin;