...
export default {
	...
	argTypes: {
		body: {
			...
			control: { type: 'text' },
			defaultValue:
				'Vivamus nunc massa, sollicitudin eget ex eget, pellentesque ultrices felis. Nunc at tempus purus. Nulla diam sem, consectetur id magna vitae, pellentesque viverra ipsum.',
