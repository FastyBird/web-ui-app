...
Default.args = {
  ...
  buttons: `
    <fb-ui-button size="${FbSizeTypes.SMALL}" @click="onClick">Add</fb-ui-button>
    <fb-ui-button size="${FbSizeTypes.SMALL}" variant="${FbUiButtonVariantTypes.WARNING}" :icon="true"  @click="onClick">
