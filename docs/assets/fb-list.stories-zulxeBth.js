...
<\/script>`}}},tags:["hideInSidebar"],render:()=>({components:{ElButton:de,ElSwitch:ge,ElIcon:g,FbList:U,FbListItem:K,FasGear:A,FasPlug:V},setup:()=>{const e=F(!0),t=re("button-clicked");return{switchState:e,onClick:t,FasGear:A,FasPlug:V}},template:`
<fb-list>
    <template #heading>List of awesome items</template>
    <template #subheading>Subheading of awesome items</template>
    <template #buttons>
