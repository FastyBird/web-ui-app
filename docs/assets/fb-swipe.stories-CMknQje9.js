import{f as t,e as i,g as s,h as a}from"./index-BcvRP9C3.js";import{c as d,E as c}from"./web-ui-components.es-Dm7mOZIz.js";const n={component:d,title:"Components/Data/Swipe actions",excludeStories:/.*Data$/},e={parameters:{docs:{source:{code:`
<template>
    <fb-swipe
        :items="items"
        itemKey="id"
...
</style>`}}},tags:["hideInSidebar"],render:()=>({components:{ElIcon:c,FbSwipe:d,FasTrash:a,FasXmark:s,FasHeart:i,FasPenToSquare:t},setup:()=>({items:[{id:"a",title:"Some title",description:"some description",disabled:!1},{id:"b",title:"Some title",description:"some description",disabled:!1},{id:"c",title:"Some title",description:"some description",disabled:!1}],FasTrash:a,FasXmark:s,FasHeart:i,FasPenToSquare:t}),template:`
