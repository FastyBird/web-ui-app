...
<\/script>`}}},tags:["hideInSidebar"],render:()=>({components:{ElButton:p,ElIcon:c,FbMediaItem:l,FasWandMagicSparkles:a},setup:()=>({onClick:u("button-clicked"),FasWandMagicSparkles:a}),template:`
<fb-media-item>
    <template #left>
        <el-icon size="35">
            <fas-wand-magic-sparkles />
