import{a as s}from"./chunk-D5ZWXAHU-CGElDDNX.js";import{o as a,a as c,b as r}from"./web-ui-components.es-Dm7mOZIz.js";import{f as b}from"./vue.esm-bundler-B6vfj-5l.js";const m={component:a,title:"Components/Navigation/Bottom navigation",excludeStories:/.*Data$/},t={parameters:{docs:{source:{code:`
<template>
</template>
...
<style scoped>
</style>`}}},tags:["hideInSidebar"],render:()=>({components:{ElButton:r,FbBottomNavigation:a,FbBottomNavigationHeading:c},setup:()=>{const i=b(!1),l=s("button-clicked");return{show:i,onClick:l}},template:`
