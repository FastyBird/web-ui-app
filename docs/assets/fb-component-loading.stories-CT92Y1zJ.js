import{d as r}from"./web-ui-components.es-DzhESIc8.js";import"./vue.esm-bundler-D-GCijdt.js";const l={component:r,title:"Components/Feedback/Component loading",argTypes:{size:{type:{name:"string",required:!1},control:{type:"select"},options:["large","default","small"],description:"loading status size",table:{type:{summary:"string"},defaultValue:{summary:"default"}}}},args:{size:"default"},excludeStories:/.*Data$/},e={},n={parameters:{docs:{source:{code:`
<template>
