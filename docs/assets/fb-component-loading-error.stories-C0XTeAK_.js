import{v as d}from"./web-ui-components.es-CHpbMkEl.js";import"./vue.esm-bundler-CCHDJWTD.js";const l={component:d,title:"Components/Feedback/Component loading error",argTypes:{size:{type:{name:"string",required:!1},control:{type:"select"},options:["large","default","small"],description:"loading result size",table:{type:{summary:"string"},defaultValue:{summary:"default"}}}},args:{size:"default"},excludeStories:/.*Data$/},e={},o={parameters:{docs:{source:{code:`
<template>
